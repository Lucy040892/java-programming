...
public class ArrayAsList {
    public static void main(String[] args) {
        ...
        //nums.add(100); UnsupportedOperationException, because when we use Arrays.asList it will return
        //nums.remove(0); immutable list, that size cannot be modified.
        //nums.clear(); But we can do any other operations on it
        //WorkAround:
