...
public class CyberManiacsAvailability {
    ...
    public static void main(String[] args) {
        ...
        if(name.equalsIgnoreCase("Bekir")){
            ...
            System.out.println("Liudmyla is available weekdays after class till 10 PM Central time," +
                    " or weekends after class till 6pm Central time.");
            ...
            System.out.println("Halyna is available weekdays 30 minutes before class");
