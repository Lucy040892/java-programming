...
public class SearchForElement {
    public static void main(String[] args) {
        ...
        System.out.println(findIndex(list, "two",
                findIndex(list, "two") +1));//same as line 10

    }

    /**
     *
     * @param words - List of element given
     * @param element - The element that we are looking for
     * @return - The method returns the index where the element is found in the given ArrayList and if
     * the element does not exist the method returns -1
     */
