...
public class SmallestAndLongestWordFromArray {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(words));// String smallest = words[0];
        String[] smallAndLarge = {words[0], words[0]};// String largest = words[0];
        //0 -> smallest
        //1 -> largest
        ...
        System.out.println("Smallest word: " +smallAndLarge[0]);// smallest
        System.out.println("Largest word: " +smallAndLarge[1]); // largest
